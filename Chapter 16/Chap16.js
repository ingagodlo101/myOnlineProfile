...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Eat Gizmo, or Starve to death with Gizmo?";
            break;
        default:
            break;
    }
    ...
    switch (answerNumber) {
        ...
        case 3:
            if (answers[3] === "EAT GIZMO") {
                story.innerHTML = document.getElementById("answer15").innerHTML;
                theEnd();
            } else if (answers[3] === "STARVE TO DEATH") {
                story.innerHTML = document.getElementById("answer16").innerHTML;
                theEnd();
            } else {
